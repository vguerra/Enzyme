...
extern Gradients __enzyme_fwdvectordiff(double (*)(double, double), double,
                                        ...);
...
Gradients dfun(double x, double y) {
  Gradients dx = {1.0, 0.0};
  Gradients dy = {0.0, 1.0};
  return __enzyme_fwdvectordiff(fun, x, dx, y, dy);
}
