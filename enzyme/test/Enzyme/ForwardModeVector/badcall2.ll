...
; CHECK: define internal void @fwdvectordiffemetasubf(double* nocapture %x, <3 x double>* nocapture %"x'")
; CHECK-NEXT: entry:
...
; CHECK: define internal void @fwdvectordiffeothermetasubf(double* nocapture %x, <3 x double>* nocapture %"x'")
; CHECK-NEXT: entry:
; CHECK-NEXT:   %"arrayidx'ipg" = getelementptr inbounds <3 x double>, <3 x double>* %"x'", i64 1
; CHECK-NEXT:   %arrayidx = getelementptr inbounds double, double* %x, i64 1
