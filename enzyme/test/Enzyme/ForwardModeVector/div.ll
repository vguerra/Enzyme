...
; CHECK-NEXT:   %9 = fmul fast <2 x double> %.splat2, %7
; CHECK-NEXT:   %10 = fsub fast <2 x double> %8, %9
; CHECK-NEXT:   %11 = fmul fast <2 x double> %.splat, %.splat
; CHECK-NEXT:   %12 = fdiv fast <2 x double> %10, %11
; CHECK-NEXT:   %13 = extractelement <2 x double> %12, i64 0
; CHECK-NEXT:   %14 = insertvalue [2 x double] undef, double %13, 0
; CHECK-NEXT:   %15 = extractelement <2 x double> %12, i64 1
; CHECK-NEXT:   %16 = insertvalue [2 x double] %14, double %15, 1
