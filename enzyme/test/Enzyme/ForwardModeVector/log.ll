...
; CHECK-NEXT:   %2 = extractelement <3 x double> %0, i64 1
; CHECK-NEXT:   %3 = extractelement <3 x double> %0, i64 2
; CHECK-NEXT:   %4 = insertvalue %struct.Gradients zeroinitializer, double %1, 0
; CHECK-NEXT:   %5 = insertvalue %struct.Gradients %4, double %2, 1
; CHECK-NEXT:   %6 = insertvalue %struct.Gradients %5, double %3, 2
