...
entry:
  %0 = tail call %struct.Gradients ({ double, double } ({ double, double })*, ...) @__enzyme_fwdvectordiff({ double, double } ({ double, double })* @tester, { double, double } %x, %struct.Gradients { { double, double } { double 1.0, double 1.0 }, { double, double } { double 1.0, double 1.0 }, { double, double } { double 1.0, double 1.0 } })
