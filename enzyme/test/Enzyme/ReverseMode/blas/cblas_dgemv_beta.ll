...
define void @f(double* noalias %x, double* noalias %y, double* noalias %a, double %beta) #0 {
entry:
  tail call void @cblas_dgemv(i32 102, i32 111, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %x, i32 1, double %beta, double* %y, i32 1) #5
  ret void
}
...
entry:
  ...
  %call = call double @__enzyme_autodiff(i8* bitcast (void (double*, double*, double*, double)* @f to i8*), double* nonnull %arraydecay, double* nonnull %arraydecay1, double* nonnull %arraydecay2, double* nonnull %arraydecay3, double* nonnull %arraydecay4, double* nonnull %arraydecay5, double 2.000000e+00) #5
...
;CHECK:define internal { double } @diffef(double* noalias %x, double* %"x'", double* noalias %y, double* %"y'", double* noalias %a, double* %"a'", double %beta) #0 {
;CHECK-NEXT:entry:
;CHECK-NEXT:  tail call void @cblas_dgemv(i32 102, i32 111, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %x, i32 1, double %beta, double* %y, i32 1) #5
;CHECK-NEXT:  call void @cblas_dscal(i32 2, double %beta, double* %"y'", i32 1)
;CHECK-NEXT:  call void @cblas_dgemv(i32 102, i32 112, i32 2, i32 2, double 3.000000e+00, double* %a, i32 2, double* %"y'", i32 1, double 1.000000e+00, double* %"x'", i32 1)
;CHECK-NEXT:  call void @cblas_dger(i32 102, i32 2, i32 2, double 3.000000e+00, double* %"y'", i32 1, double* %"x'", i32 1, double* %a, i32 2)
;CHECK-NEXT:  %0 = call fast double @cblas_ddot(i32 2, double* nocapture readonly %"y'", i32 1, double* nocapture readonly %y, i32 1)
